...
public class DetailActivity extends Activity{
    ...
    void open(String u){progress.setVisibility(View.GONE); if(u==null||u.length()<1)u=url; Intent in=new Intent(DetailActivity.this, PlayerActivity.class); in.putExtra("url",u); in.putExtra("title", title.getText().toString()); startActivity(in);}    
}
